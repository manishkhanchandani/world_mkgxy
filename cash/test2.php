	...
	<!-- Header -->
		<div id="header">
			<div id="nav-wrapper"> 
				...
				<nav id="nav">
					<ul>
						<li class="active"><a href="themes/templated-linear/index.html">Homepage</a></li>
						<li><a href="themes/templated-linear/left-sidebar.html">Left Sidebar</a></li>
						<li><a href="themes/templated-linear/right-sidebar.html">Right Sidebar</a></li>
						<li><a href="themes/templated-linear/no-sidebar.html">No Sidebar</a></li>
					</ul>
				</nav>
			</div>
			<div class="container"> 
	...
	<!-- Main -->
		<div id="main">
			<div id="content" class="container">
				...
				<div class="row">
					<section class="6u">
						<a href="#" class="image full"><img src="themes/templated-linear/images/pic01.jpg" alt=""></a>
						<header>
					...
					<section class="6u">
						<a href="#" class="image full"><img src="themes/templated-linear/images/pic02.jpg" alt=""></a>
						<header>
							<h2>Mauris vulputate dolor</h2>
						</header>
						<p>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula. Pellentesque viverra vulputate enim. Aliquam erat volutpat. Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum.</p>
				...
				<div class="row">
					<section class="6u">
						<a href="#" class="image full"><img src="themes/templated-linear/images/pic03.jpg" alt=""></a>
						<header>
							<h2>Mauris vulputate dolor</h2>
						</header>
						<p>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula. Pellentesque viverra vulputate enim. Aliquam erat volutpat. Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum.</p>
					...
					<section class="6u">
						<a href="#" class="image full"><img src="themes/templated-linear/images/pic04.jpg" alt=""></a>
						<header>
							<h2>Mauris vulputate dolor</h2>
						</header>
						<p>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula. Pellentesque viverra vulputate enim. Aliquam erat volutpat. Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum.</p>
