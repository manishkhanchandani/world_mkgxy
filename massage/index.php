		...
		<!-- Team -->
			<div class="wrapper style5">
				<section id="team" class="container">
					...
					<div class="row">
						<div class="3u">
							<a href="#" class="image"><img src="http://www.mens-hairstyle.com/wp-content/uploads/2013/03/Mens-short-black-hairstyles.jpg" alt="" width="182" height="182"></a>
							<h3>Molly Millions</h3>
							<p>In posuere eleifend odio quisque semper augue wisi ligula.</p>
						</div>
						<div class="3u">
							<a href="#" class="image"><img src="https://p.gr-assets.com/540x540/fit/hostedimages/1385617867/7186337.jpg" alt="" width="182" height="182"></a>
	...
	<!-- Footer -->
		<div id="footer">
			<section class="container">
				...
				<ul class="icons">
					<li class="active"><a href="https://www.facebook.com/redcross" class="fa fa-facebook" target="_blank"><span>Facebook</span></a></li>
					<li><a href="https://twitter.com/redcross" class="fa fa-twitter" target="_blank"><span>Twitter</span></a></li>
					<li><a href="http://www.pinterest.com/amredcross/" class="fa fa-dribbble" target="_blank"><span>Pinterest</span></a></li>
					<li><a href="https://plus.google.com/+redcross/posts" class="fa fa-google-plus" target="_blank"><span>Google+</span></a></li>
				</ul>
				<hr />
			</section>
